...
const navigation = [
  ...
  { name: "Role & Admin", href: "#", current: false },
  { name: "Settings", href: "#", current: false },
  { name: "Stock", href: "#", current: false },
  { name: "Supply", href: "#", current: false },
];
                          ...
                          {({ active }) => (
                            <a
                              ...
                              className={classNames(
                                active ? "bg-gray-100" : "",
                                "block px-4 py-2 text-sm bg-[#FEF5F6] text-[#8F0A13]"
                              )}
                            >
                              Logout
                            </a>
              ...
              <div className="space-y-1 px-2 pb-3 pt-2">
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    className={classNames(
                      item.current
                        ? "text-[#5D5FEF] font-semibold  font-family-quicksand"
                        : "text-[#98949E]  font-family-quicksand",
